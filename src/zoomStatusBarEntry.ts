...
const selectZoomLevelCommandId = '_tga.selectZoomLevel';
...
export class ZoomStatusBarEntry extends OwnedStatusBarEntry {
	...
	constructor() {
		super('status.tga.zoom', localize('zoomStatusBar.name', "Image Zoom"), vscode.StatusBarAlignment.Right, 102 /* to the left of editor size entry (101) */);
